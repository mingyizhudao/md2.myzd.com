...
$(function () {
    ...
    function setImg(data) {
        var firstImgClick = 'http://static.mingyizhudao.com/147634523727390';
        var secondImgClick = 'http://static.mingyizhudao.com/147634523577826';
        if (data != '') {
        ...
        var uploader2 = Qiniu2.uploader({
            ...
            init: {
                ...
                'UploadComplete': function () {
                    //图片信息存储
                    var allImg = firstData + secondData ;
