...
$urlCardList = $this->createUrl('userbank/cardList', array('addBackBtn' => 1,'card_id'=>''));
        ...
        <div class="pl10 pr10 bg-white">
            ...
            <div class="inputRow">
                <div class="grid bb-gray">
                    ...
                    <div class="col-1">
                        <?php echo $form->textField($model, 'phone', array('name' => 'phone', 'placeholder' => '请输入您在办理该卡时预留的手机号码','maxlength'=>'11', 'class' => 'noPaddingInput')); ?>
                    </div>
                </div>
            </div>
            <div class="inputRow">
...
//            error.appendTo(element.parents('.inputRow'));
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.status == 'ok') {
                         ...
                         location.href = returnUrl+'/'+'<?php echo $card_id;?>';
 ...
 btnSubmit.click(function(){
    location.href="<?php echo $urlCardList;?>"+'/312';
 })
